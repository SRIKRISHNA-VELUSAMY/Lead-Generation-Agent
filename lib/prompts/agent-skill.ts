/**
 * Agent system prompt — bundled with the app (works in Trigger.dev cloud).
 * Keep in sync with skills/agent_skill.md when editing instructions.
 */
export const AGENT_SKILL_PROMPT = `# Lead Generation Agent — System Instructions
